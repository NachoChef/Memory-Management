...
package memoryManagement is
   type stackElement is (Deering, An, Najar, Burris, Zhou, Shashidhar, Shannon, Yang, Smith, Wei, Rabieh, Song, Cho, Varol, Karabiyik, Cooper, McGuire, Hope, Pray, NoHope);
   type StackSpace is array(Integer range <>) of stackElement;
   type growthSpace is array(Positive range <>) of Integer;
   procedure reallocate (stack : in out StackSpace; top : in out growthSpace; base : in out growthSpace; oldTop : in out growthSpace; EqualAllocate : float; K : integer);
